...
<tr id="table_pagination">
	{{IF:BEFORE_PAGINATION_TD}}
	<td>
		{before_pagination}
	</td>
	{{ELSE:BEFORE_PAGINATION_TD}}{{ENDIF:BEFORE_PAGINATION_TD}}
	<td colspan="6" style="background:#ffffff;border-top:0;">
		<div class="pa_middle_c_l_b_pagination" style="margin-bottom: 30px">
			{{IF:LOAD_MORE}}
