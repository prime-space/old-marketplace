		...
		<div class="panel panel-headline" style="background-color: #fb8484;color: #fff;font-size: 16px;font-weight: bold;">
			<div class="panel-body">
				<div class="spoiler" >
					Обратите внимание!
					<br><br>
					Создан новый мерчант для Ваших магазинов. Новые возможности и улучшенная работа!
					<br><br>
					Вам необходимо в ближайшее время зарегистрироваться и произвести интеграцию
					с новым сервисом - <a href="https://primepayer.com" target="_blank" style="color:white;text-decoration:underline;">PRIMEPAYER.COM</a>
					<br><br>
					Данный мерчант в скором времени поддерживатся не будет.
				</div>
			</div>
		</div>
	</div>
