...
<table class="table table-striped table_page">
    ...
    <tr>
        ...
        <td class="padding_10 vertical_align"><b>getProducts</b></td>
    </tr>
    <tr>
        <td class="font_weight_700 padding_10 text_align_r vertical_align">Описание:</td>
        <td class="padding_10 vertical_align">Запрос позволяет получить список товаров парртнерской программы.</td>
    </tr>
    <tr>
        <td class="font_weight_700 padding_10 text_align_r vertical_align">URL:</td>
        <td class="padding_10 vertical_align">{siteAddr}api/v1/partner/getProducts/</td>
    </tr>
    <tr>
        ...
        <td class="padding_b_5 padding_l_10 padding_r_5 padding_t_5">
            ...
            <table class="table table-striped table_page table_page_b">
                ...
                <tr>
                    ...
                    <td class="padding_10 vertical_align">groupId (Опционально)</td>
                </tr>
                <tr>
                    <td class="font_weight_700 padding_10 text_align_r vertical_align">Описание:</td>
                ...
                <tr>
                    <td style="width: 100px;" class="font_weight_700 padding_10 text_align_r vertical_align">Параметр:</td>
                    <td class="padding_10 vertical_align">query (Опционально)</td>
                </tr>
                <tr>
                    <td class="font_weight_700 padding_10 text_align_r vertical_align">Описание:</td>
                    <td class="padding_10 vertical_align">(string) Поисковая строка</td>
                </tr>
                </tbody>
            </table>
                ...
                <tr>
                    ...
                    <td class="padding_b_0">
                        ...
                        <table class="table table-striped table_page table_page_b">
                            ...
                            <tr>
                                <td class="font_weight_700 padding_10 text_align_r vertical_align">fee:</td>
                                <td class="padding_10 vertical_align">Суммарная комиссия партнера</td>
                            </tr>
                            <tr>
                                <td class="font_weight_700 padding_10 text_align_r vertical_align">pictureUrl:</td>
                                <td class="padding_10 vertical_align">Адрес картинки</td>
                            </tr>
                            </tbody>
                        </table>
...
<table class="table table-striped table_page">
    ...
    <tr>
        <td class="font_weight_700 padding_10 text_align_r vertical_align">Метод:</td>
        <td class="padding_10 vertical_align"><b>getGroup (УСТАРЕВШИЙ, используйте getProducts)</b></td>
    </tr>
    <tr>
        <td class="font_weight_700 padding_10 text_align_r vertical_align">Описание:</td>
