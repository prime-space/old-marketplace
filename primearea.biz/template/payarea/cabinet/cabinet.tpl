		...
		<div class="panel panel-headline" style="background-color: #5cb85c;color: #fff;font-size: 16px;font-weight: bold;">
			<div class="panel-body">
				...
				<div id="newsBox" class="spoiler collapse {expandWishes}" aria-expanded="true">
					Спешим анонсировать, что мы приняли решение полностью переработать наш сервис!<br>
					Текущий функционал уже давно не отвечает современным стандартам. Мы это знаем, вы это знаете, однако не смотря на это продолжаем выгодно сотрудничать.
					Мы это очень ценим и понимаем как мы друг другу нужны.<br>
					В новой версии продукта мы планируем сделать особый упор на безопасность, техподдержку, удобство пользовательского интерфейса, партнерскую программу, более прозрачные выплаты и многое другое<br>
					Мы знаем как сделать круто!<br>
					<br>
					В связи с этим, мы просим вас оставить свои пожелания и предложения.<br>
					Все интересные идеи будут реализованы в новом скрипте.<br>
