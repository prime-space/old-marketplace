...
<html>
	<head>
		...
		<link rel="SHORTCUT ICON" href="/style/img/favicon_pay2store.ico" type="image/x-icon">
		...
		<footer>
			<div class="col-md-9">
				<div class="footer-links">
					...
					<a href="https://pay2store.com/contact/">Контакты</a>
				</div>
				<p class="copyright">© 2018 <a href="/" target="_blank">PAY2STORE.COM</a>. All Rights Reserved.</p>
			</div>
			<div class="col-md-3">
				<div class="social-icons">
					<p>Мы в социальных сетях</p>
					<a target="_blank" href="https://vk.com/ipay2store"><i class="fa fa-vk">&nbsp;</i></a>
