...
<div class="panel panel-headline">
	<div class="panel-heading">
		<h3 class="panel-title">Партнерская программа v1 PAY2STORE</h3>
	</div>
				...
				<td class="padding_10 text_align_c vertical_align">
					...
					<div class="primeareaGroup">
						<div class="primeareaLot">
							<div class="img">
								<img src="https://pay2store.com{img}">
							</div>
							<div class="name">
								<a target="_blank" href="https://pay2store.com/buy/{pid}/{uid}/">{title}</a>
							</div>
							<div class="price">
								<a target="_blank" href="https://pay2store.com/buy/{pid}/{uid}/">{price}</a>
							</div>
						</div>
					</div>
		...
		<table class="table table-striped table_page">
			...
			<tr>
				...
				<td class="padding_10">
					...
					<pre class="html">https://pay2store.com/buy/{pid}/{uid}</pre>
				</td>
			</tr>
			</tbody>
		</table>
