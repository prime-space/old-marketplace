...
class API extends BaseAPI {
     ...
     * @param array[] $options Key-value parameters collection
     * @throws FormatError If authorization header is missing or
     * has an invalid value
     * @throws TokenError If a token is nonexistent, expired or revoked
     * @throws  ScopeError If a token does not have permissions for the
     * requested operation
